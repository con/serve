...
The homepage features an interactive Mermaid diagram showing the bidirectional funnel — ingestion from diverse sources into the git-annex/DataLad vault, and conservation/distribution out to external resources and knowledge bases. See the [rendered diagram](https://con.github.io/serve/#architecture).
